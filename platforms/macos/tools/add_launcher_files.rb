...
%w[Launcher MainShell AIChat MenuPanel RaycastTab].each do |dir|
...
["Launcher*Tests.swift", "ShellTab*Tests.swift", "AI*Tests.swift", "MenuPanel*Tests.swift", "Search*Tests.swift", "Raycast*Tests.swift"].each do |pattern|
