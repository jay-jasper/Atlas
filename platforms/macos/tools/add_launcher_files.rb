...
%w[Launcher MainShell AIChat MenuPanel RaycastTab Plugins].each do |dir|
...
["Launcher*Tests.swift", "ShellTab*Tests.swift", "AI*Tests.swift", "MenuPanel*Tests.swift", "Search*Tests.swift", "Raycast*Tests.swift", "Plugin*Tests.swift", "DynamicPlugin*Tests.swift"].each do |pattern|
